...
function useTransactionFlow(opts) {
  ...
  const [overrides, setOverrides] = useState(void 0);
  const [state, setState] = useState({ step: "estimating", preset: "standard" });
...
function Gen({ wei, busy }) {
  return /* @__PURE__ */ jsxs("span", { className: "gltk-total-value", "data-busy": busy ? "true" : void 0, children: [
    formatGen(wei),
    /* @__PURE__ */ jsx("span", { className: "gltk-unit", children: "GEN" })
  ] });
}
function ReceiptRow(props) {
  return /* @__PURE__ */ jsxs("div", { className: "gltk-row", children: [
    /* @__PURE__ */ jsxs("span", { className: "gltk-row-label", children: [
      props.label,
      props.hint ? /* @__PURE__ */ jsx("span", { className: "gltk-row-hint", children: props.hint }) : null
    ] }),
    /* @__PURE__ */ jsxs("span", { className: "gltk-row-value", children: [
      formatGen(props.wei),
      /* @__PURE__ */ jsx("span", { className: "gltk-unit", children: "GEN" })
    ] })
  ] });
...
function FeeReceipt({ quote, busy }) {
  return /* @__PURE__ */ jsxs("div", { className: "gltk-receipt", children: [
    /* @__PURE__ */ jsx(
      ReceiptRow,
      {
    ...
    quote.breakdown.messageFees > 0n ? /* @__PURE__ */ jsx(ReceiptRow, { label: "Message budget", hint: "child transactions", wei: quote.breakdown.messageFees }) : null,
    quote.userValue > 0n ? /* @__PURE__ */ jsx(ReceiptRow, { label: "Value sent", hint: "delivered to the contract", wei: quote.userValue }) : null,
    /* @__PURE__ */ jsxs("div", { className: "gltk-total", children: [
      /* @__PURE__ */ jsx("span", { className: "gltk-total-label", children: "Total deposit" }),
      /* @__PURE__ */ jsx(Gen, { wei: quote.total, busy })
    ] }),
    /* @__PURE__ */ jsx("p", { className: "gltk-refundable", children: "Unused amounts are refunded when the transaction finalizes." }),
    /* @__PURE__ */ jsxs("p", { className: "gltk-source", "data-source": quote.source, children: [
...
function PresetSelector(props) {
  return /* @__PURE__ */ jsx("div", { className: "gltk-presets", role: "radiogroup", "aria-label": "Fee preset", children: Object.keys(PRESET_COPY).map((preset) => /* @__PURE__ */ jsxs(
    "button",
    {
      type: "button",
      role: "radio",
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("small", { children: PRESET_COPY[preset].sub })
      ]
    },
    preset
  )) });
...
function CapsShield({ quote }) {
  return /* @__PURE__ */ jsxs("div", { className: "gltk-caps", children: [
    /* @__PURE__ */ jsx("div", { className: "gltk-caps-title", children: "Price protection" }),
    /* @__PURE__ */ jsxs("div", { className: "gltk-caps-grid", children: [
      /* @__PURE__ */ jsxs("span", { className: "gltk-cap", children: [
        "Time-unit price cap ",
    ...
    /* @__PURE__ */ jsx("p", { className: "gltk-caps-note", children: "If network prices rise above any cap, the transaction is rejected and nothing is charged." })
  ] });
}
function VerifyBadge(props) {
  if (!props.feeConfigHash) return null;
  const verified = props.snapState === "verified";
  return /* @__PURE__ */ jsxs("div", { className: "gltk-verify", "data-state": verified ? "verified" : void 0, children: [
    /* @__PURE__ */ jsx("span", { children: verified ? "\u2713 Verified by GenLayer Snap" : "Policy fingerprint" }),
    /* @__PURE__ */ jsx("code", { children: shortHash(props.feeConfigHash, 10, 6) })
  ] });
}
function HoldToSign(props) {
  const holdMs = props.holdMs ?? 900;
  const [holding, setHolding] = useState2(false);
  const timer = useRef2();
  const touchHandled = useRef2(false);
  ...
  return /* @__PURE__ */ jsxs(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("span", { className: "gltk-hold-fill", "aria-hidden": true }),
        props.label ?? "Approve & sign",
        /* @__PURE__ */ jsx("span", { className: "gltk-hold-hint", children: "hold to confirm" })
      ]
    }
  );
}
...
function Timeline({ status }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "gltk-timeline", "aria-live": "polite", children: PHASES.map((phase, index) => {
    ...
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("span", { className: "gltk-node-rail", children: [
            /* @__PURE__ */ jsx("span", { className: "gltk-node-dot" }),
            /* @__PURE__ */ jsx("span", { className: "gltk-node-line" })
          ] }),
          /* @__PURE__ */ jsxs("span", { className: "gltk-node-label", children: [
            isOutcomeNode ? `Decided \u2014 ${outcome.title}` : phase.label,
            phase.key === "submitted" && status.genlayerTxId ? /* @__PURE__ */ jsxs("span", { className: "gltk-node-sub", children: [
              "tx ",
              /* @__PURE__ */ jsx("code", { children: shortHash(status.genlayerTxId) })
            ] }) : null,
            phase.key === "submitted" && status.queuePosition !== void 0 && current <= order.indexOf("pending") ? /* @__PURE__ */ jsx("span", { className: "gltk-node-sub", children: status.queuePosition === 0 ? "next in queue" : `${status.queuePosition} ahead in queue` }) : null,
            phase.key === "decided" && isOutcomeNode && outcome.tone === "success" && status.contractAddress ? /* @__PURE__ */ jsxs("span", { className: "gltk-node-sub", children: [
              "contract ",
              /* @__PURE__ */ jsx("code", { children: shortHash(status.contractAddress) })
            ] }) : null
          ] })
        ]
      },
...
function GenLayerTransactionPanel(props) {
  ...
  const target = useMemo2(() => describeTarget(props.tx), [props.tx]);
  const { state } = flow;
  const doneRef = useRef2(false);
  ...
  return /* @__PURE__ */ jsx("div", { className: "gltk-root", "data-theme": props.theme ?? "light", children: /* @__PURE__ */ jsxs("div", { className: "gltk-panel", children: [
    /* @__PURE__ */ jsxs("div", { className: "gltk-head", children: [
      /* @__PURE__ */ jsx("span", { className: "gltk-head-title", children: "GenLayer transaction" }),
      props.network ? /* @__PURE__ */ jsx("span", { className: "gltk-head-network", children: props.network }) : null
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "gltk-target", children: [
      /* @__PURE__ */ jsx("span", { className: "gltk-target-kind", children: target.kind }),
      /* @__PURE__ */ jsx("span", { className: "gltk-target-what", children: target.what })
    ] }),
    reviewing && flow.quote?.gasless ? /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsxs("div", { className: "gltk-gasless", children: [
        /* @__PURE__ */ jsx("p", { className: "gltk-gasless-title", children: "No fees on this network" }),
        /* @__PURE__ */ jsx("p", { className: "gltk-gasless-detail", children: "Fee accounting is disabled here \u2014 no deposit is taken and nothing is charged." })
      ] }),
      flow.quote.userValue > 0n ? /* @__PURE__ */ jsx(FeeReceipt, { quote: flow.quote, busy }) : null,
      /* @__PURE__ */ jsx("div", { className: "gltk-actions", children: /* @__PURE__ */ jsx(HoldToSign, { onConfirm: () => void flow.approve(), disabled: busy }) })
    ] }) : null,
    reviewing && !flow.quote?.gasless ? /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx(PresetSelector, { value: flow.preset, onChange: flow.setPreset, disabled: busy }),
      /* @__PURE__ */ jsxs("details", { className: "gltk-advanced", children: [
        /* @__PURE__ */ jsx("summary", { children: "Advanced" }),
        /* @__PURE__ */ jsx("div", { className: "gltk-advanced-grid", children: /* @__PURE__ */ jsxs("label", { className: "gltk-field", children: [
          /* @__PURE__ */ jsx("span", { children: "Appeal rounds" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              type: "number",
      ...
      flow.quote ? /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx(FeeReceipt, { quote: flow.quote, busy }),
        /* @__PURE__ */ jsx(CapsShield, { quote: flow.quote }),
        /* @__PURE__ */ jsx(
          VerifyBadge,
          {
        ...
        flow.quote.queue ? /* @__PURE__ */ jsx("p", { className: "gltk-queue", "data-clear": flow.quote.queue.pendingAhead === 0 ? "true" : void 0, children: flow.quote.queue.pendingAhead === 0 ? "Queue is clear \u2014 starts immediately" : `${flow.quote.queue.pendingAhead} transaction${flow.quote.queue.pendingAhead === 1 ? "" : "s"} queued ahead for this contract` }) : null
      ] }) : null,
      /* @__PURE__ */ jsx("div", { className: "gltk-actions", children: /* @__PURE__ */ jsx(HoldToSign, { onConfirm: () => void flow.approve(), disabled: busy || !flow.quote }) })
    ] }) : null,
    state.step === "signing" ? /* @__PURE__ */ jsxs(Fragment, { children: [
      state.quote ? /* @__PURE__ */ jsx(FeeReceipt, { quote: state.quote }) : null,
      /* @__PURE__ */ jsxs("div", { className: "gltk-outcome", "data-tone": "warn", children: [
        /* @__PURE__ */ jsx("p", { className: "gltk-outcome-title", children: "Waiting for your wallet" }),
        /* @__PURE__ */ jsx("p", { className: "gltk-outcome-detail", children: "Confirm the transaction in your wallet to continue." })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "gltk-actions" })
    ] }) : null,
    state.step === "tracking" || state.step === "done" ? /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx(Timeline, { status: state.status }),
      state.step === "done" ? /* @__PURE__ */ jsx(Outcome, { status: state.status }) : null,
      /* @__PURE__ */ jsx("div", { className: "gltk-actions", children: state.step === "done" ? /* @__PURE__ */ jsx("div", { className: "gltk-link-row", children: /* @__PURE__ */ jsx("button", { type: "button", onClick: flow.reset, children: "New transaction" }) }) : null })
    ] }) : null,
    state.step === "error" ? /* @__PURE__ */ jsx(ErrorSurface, { message: state.message, onRetry: flow.reset }) : null
  ] }) });
}
function Outcome({ status }) {
  const outcome = describeOutcome(status.statusName, status.executionResultName);
  return /* @__PURE__ */ jsxs("div", { className: "gltk-outcome", "data-tone": outcome.tone, children: [
    /* @__PURE__ */ jsx("p", { className: "gltk-outcome-title", children: outcome.title }),
    /* @__PURE__ */ jsx("p", { className: "gltk-outcome-detail", children: outcome.detail })
  ] });
}
function ErrorSurface({ message, onRetry }) {
  const error = describeError(message);
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("div", { className: "gltk-outcome", "data-tone": "error", children: [
      /* @__PURE__ */ jsx("p", { className: "gltk-outcome-title", children: error.title }),
      /* @__PURE__ */ jsx("p", { className: "gltk-outcome-detail", children: error.detail }),
      /* @__PURE__ */ jsx("pre", { className: "gltk-outcome-raw", children: error.raw })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "gltk-actions", children: /* @__PURE__ */ jsx("div", { className: "gltk-link-row", children: /* @__PURE__ */ jsx("button", { type: "button", onClick: onRetry, children: "Re-estimate and retry" }) }) })
  ] });
}
