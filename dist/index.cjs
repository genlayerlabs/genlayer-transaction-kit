...
__export(index_exports, {
  createTransactionKit: () => createTransactionKit
});
module.exports = __toCommonJS(index_exports);
var import_ethers = require("ethers");
var import_genlayer_js = require("genlayer-js");
var abiCoder = import_ethers.AbiCoder.defaultAbiCoder();
...
var QUEUES_SELECTOR = (0, import_ethers.id)("queues()").slice(0, 10);
var PENDING_COUNT_SELECTOR = (0, import_ethers.id)("getPendingTxCount(address)").slice(0, 10);
...
var hashFeeConfig = (distribution) => (0, import_ethers.keccak256)(
  abiCoder.encode(
    [
...
var mapTrackedStatus = (genlayerTxId, transaction) => {
  ...
  if (isDecided(statusName)) {
    status.successful = (0, import_genlayer_js.isSuccessful)(transaction);
  }
...
function createTransactionKit(opts) {
  ...
  const client = (0, import_genlayer_js.createClient)({
    chain: opts.chain,
